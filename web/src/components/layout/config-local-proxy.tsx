...
import { defaultConfig, normalizeLocalProxyUrl, useConfigStore } from "@/stores/use-config-store";

const LOCAL_PROXY_PACKAGE = "@basketikun/canvas-proxy";
const DEFAULT_LOCAL_PROXY_URL = defaultConfig.proxyUrl;
