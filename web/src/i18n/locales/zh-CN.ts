export default {
    ...
    canvas: {
        ...
        shortcut: {
            ...
            cloneDrag: "Option/Alt + 拖动复制节点（含内部连线）",
            delete: "删除选中",
            group: "将选中节点打组",
            ungroup: "解散选中的组",
            escape: "取消选择并关闭浮层",
