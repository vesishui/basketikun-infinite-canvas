export default {
    ...
    canvas: {
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", queryVideoTask: "Get task status", queryVideoTaskTitle: "Query video generation status by task ID", videoTaskId: "Task ID", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size", group: "Group", groupTitle: "Wrap selected nodes in a group", ungroup: "Ungroup", ungroupTitle: "Remove grouping from selected nodes", clearContentTitle: "Clear node content", clearContent: "Clear", arrangeSelected: "Arrange selected nodes", arrangeGrid: "Grid arrangement", arrangeVertical: "Vertical arrangement", arrangeHorizontal: "Horizontal arrangement", groupColorTitle: "Set group background color" },
        ...
        shortcut: {
            ...
            cloneDrag: "Option/Alt + drag to duplicate nodes (with internal connections)",
    ...
    config: {
        ...
        channelEditor: {
            ...
            disabled: "Disabled",
            disabledDescription: "Disabled channels are hidden from model pickers and never used for generation.",
